...
%\begin{itemize}
% using an itemize environment so we don't count these in the publication count

%\subsubsection*{In Preparation}

%using the empty brackets to prevent a bullet point

%\item[] Negash EW, {\bfseries Barr WA}. Environmental change and hominin evolution: revisiting the hypotheses and paleoenvironmental evidence in eastern Africa. In preparation. Invited submission to \emph{Evolutionary Anthropology}

%\item[] {\bfseries Barr WA} Wood, BA. Blinded by the rift? How understanding of human evolution is constrained by spatial bias in the fossil record. Will submit in November to \emph{Nature Ecology and Evolution} after a favorable pre-submission inquiry.  
...
%\item[] Negash EW, Alemseged Z, {\bfseries Barr WA}, Behrensmeyer AK, Blumenthal SA, Bobe R, Carvalho S, Cerling TE, Chritz KL, McGuire E, Uno K, Wood B, Wynn J. Modern African ecosystems as landscape-scale analogues for reconstructing woody cover and early hominin environments. \emph{Proceedings of the National Academy of Sciences}


%\item[] Anderson S, Kovarovic K, {\bfseries Barr WA}. A 3D geometric morphometric analysis of the bovid distal humerus, with special reference to \emph{Rusingoryx atopocranion} (Pleistocene, Eastern Africa). \emph{Journal of Anatomy}. 
...
\item[] Powell V, {\bfseries Barr WA}, Hammond AS, Wood BA. Behavioral and phylogenetic correlates of limb length proportions in extant apes and monkeys: implications for interpreting fossil associated skeletons. \emph{Journal of Human Evolution}
